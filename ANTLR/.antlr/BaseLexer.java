...
public class BaseLexer extends Lexer {
	...
	public static final int
		LT=1, GT=2, IMPORT=3, NUM=4, WORD=5, LOAD=6, SPORT=7, LINE_COMMENT=8, 
		WS=9;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"LT", "GT", "IMPORT", "NUM", "WORD", "LOAD", "SPORT", "LINE_COMMENT", 
			"WS", "ESC"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "LT", "GT", "IMPORT", "NUM", "WORD", "LOAD", "SPORT", "LINE_COMMENT", 
			"WS"
		};
	}
